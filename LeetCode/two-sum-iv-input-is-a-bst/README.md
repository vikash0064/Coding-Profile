...
| :--- | :--- |
| 🔢 **Problem Number** | **#653** |
| 🔗 **Problem Link** | [View Full Problem on LeetCode](https://leetcode.com/problems/two-sum/submissions/2092433764/) |
| 🎯 **Difficulty Level** | **Medium** |
| ⏱️ **Runtime Performance** | `43 ms` |
| 💾 **Memory Footprint** | `14.10 MB` |
...
### 1. Problem Summary
The problem **"Two Sum IV - Input Is A BST"** asks us to modify a sorted array in-place so that all duplicate elements are removed, leaving each unique element appearing exactly once. We need to preserve the relative order of unique elements and return the total count $k$ of unique elements.
