...
| :--- | :--- |
| 🔢 **Problem Number** | **#3** |
| 🔗 **Problem Link** | [View Full Problem on LeetCode](https://leetcode.com/problems/longest-substring-without-repeating-characters/description/) |
...
### 1. Problem Summary
The problem **"Longest Substring Without Repeating Characters"** asks us to modify a sorted array in-place so that all duplicate elements are removed, leaving each unique element appearing exactly once. We need to preserve the relative order of unique elements and return the total count $k$ of unique elements.
