...
| :--- | :--- |
| 🔢 **Problem Number** | **#2006** |
| 🔗 **Problem Link** | [View Full Problem on LeetCode](https://leetcode.com/problems/two-sum/submissions/2092424302/) |
| 🎯 **Difficulty Level** | **Medium** |
| ⏱️ **Runtime Performance** | `39
ms` |
| 💾 **Memory Footprint** | `14.18
MB` |
...
### 1. Problem Summary
The problem **"Count Number Of Pairs With Absolute Difference K"** asks us to modify a sorted array in-place so that all duplicate elements are removed, leaving each unique element appearing exactly once. We need to preserve the relative order of unique elements and return the total count $k$ of unique elements.
