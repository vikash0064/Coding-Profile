...
| :--- | :--- |
| 🔢 **Problem Number** | **N/A** |
| 🔗 **Problem Link** | [View Full Problem on LeetCode](https://leetcode.com/problems/remove-duplicates-from-sorted-array/submissions/2092270867/) |
| 🎯 **Difficulty Level** | **Medium** |
| ⏱️ **Runtime Performance** | `0
ms` |
| 💾 **Memory Footprint** | `22.52
MB` |
