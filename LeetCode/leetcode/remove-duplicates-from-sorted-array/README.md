...
| :--- | :--- |
| 🔢 **Problem Number** | **N/A** |
| 🔗 **Problem Link** | [View Full Problem on LeetCode](https://leetcode.com/problems/remove-duplicates-from-sorted-array/submissions/2092276306/) |
| 🎯 **Difficulty Level** | **Medium** |
| ⏱️ **Runtime Performance** | `0
ms` |
| 💾 **Memory Footprint** | `22.72
MB` |
...
### 1. Problem Summary
The problem **"Remove Duplicates From Sorted Array"** asks us to modify a sorted array in-place so that all duplicate elements are removed, leaving each unique element appearing exactly once. We need to preserve the relative order of unique elements and return the total count $k$ of unique elements.
