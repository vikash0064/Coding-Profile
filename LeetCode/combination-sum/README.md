...
| :--- | :--- |
| 🔢 **Problem Number** | **#39** |
| 🔗 **Problem Link** | [View Full Problem on LeetCode](https://leetcode.com/problems/combination-sum/submissions/2099987021/) |
| 🎯 **Difficulty Level** | **Medium** |
| ⏱️ **Runtime Performance** | `0 ms` |
| 💾 **Memory Footprint** | `14.01 MB` |
| 🏷️ **Topic Classification** | `Array` `Backtracking` |
...
### 1. Problem Summary
The problem **"Combination Sum"** asks us to modify a sorted array in-place so that all duplicate elements are removed, leaving each unique element appearing exactly once. We need to preserve the relative order of unique elements and return the total count $k$ of unique elements.
...
- **Category & Pattern**: `Array` `Backtracking`
- **Language**: `cpp`
