...
| :--- | :--- |
| 🔢 **Problem Number** | **N/A** |
| 🔗 **Problem Link** | [View Full Problem on LeetCode](https://leetcode.com/problems/remove-duplicates-from-sorted-array/submissions/2092250109/) |
| 🎯 **Difficulty Level** | **Easy** |
| ⏱️ **Runtime Performance** | `0 ms` |
| 💾 **Memory Footprint** | `22.60
MB` |
