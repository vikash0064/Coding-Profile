...
| :--- | :--- |
| 🔢 **Problem Number** | **#13** |
| 🔗 **Problem Link** | [View Full Problem on LeetCode](https://leetcode.com/problems/roman-to-integer/submissions/) |
| 🎯 **Difficulty Level** | **Easy** |
| ⏱️ **Runtime Performance** | `0 ms` |
| 💾 **Memory Footprint** | `11.2 MB` |
...
### 1. Problem Summary
The problem **"Roman To Integer"** asks us to modify a sorted array in-place so that all duplicate elements are removed, leaving each unique element appearing exactly once. We need to preserve the relative order of unique elements and return the total count $k$ of unique elements.
